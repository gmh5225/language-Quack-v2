...
@f.x = internal global %struct.x zeroinitializer, align 4

; Function Attrs: noinline nounwind optnone ssp uwtable
define dso_local void @f() #0 {
  store i32 3, i32* getelementptr inbounds (%struct.x, %struct.x* @f.x, i32 0, i32 0), align 4
  store i32 4, i32* getelementptr inbounds (%struct.x, %struct.x* @f.x, i32 0, i32 1), align 4
  ret void
}
