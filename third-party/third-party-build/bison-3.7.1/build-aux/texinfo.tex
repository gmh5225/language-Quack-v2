...
\ifx\putwordInstanceVariableof\undefined \gdef\putwordInstanceVariableof{Instance IdentifierExpression of}\fi
...
\ifx\putwordDefvar\undefined    \gdef\putwordDefvar{IdentifierExpression}\fi
...
\def\expandablevalue#1{%
  \expandafter\ifx\csname SET#1\endcsname\relax
    {[No value for ``#1'']}%
    \message{IdentifierExpression `#1', used in @value, is not set.}%
  \else
